...
function calendarJs(elementOrId, options, searchOptions) {
  ...
  function setTranslationStringOptions() {
    if (isInvalidOptionArray(_options.dayHeaderNames, 7)) {
      _options.dayHeaderNames = ["Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag", "Sonntag"];
    }
    if (isInvalidOptionArray(_options.dayNames, 7)) {
      _options.dayNames = ["Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag", "Sonntag"];
    }
    if (isInvalidOptionArray(_options.dayNamesAbbreviated, 7)) {
      _options.dayNamesAbbreviated = ["Mon", "Die", "Mit", "Do", "Fr", "Sam", "Son"];
    }
    if (isInvalidOptionArray(_options.monthNames, 12)) {
      _options.monthNames = ["Januar", "Feburar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"];
    }
    ...
    _options.previousMonthTooltipText = getDefaultString(_options.previousMonthTooltipText, "Vorheriger Monat");
    _options.nextMonthTooltipText = getDefaultString(_options.nextMonthTooltipText, "Nächster Monat");
    _options.previousDayTooltipText = getDefaultString(_options.previousDayTooltipText, "Gestern");
    _options.nextDayTooltipText = getDefaultString(_options.nextDayTooltipText, "Morgen");
    _options.previousWeekTooltipText = getDefaultString(_options.previousWeekTooltipText, "Vorherige Woche");
    _options.nextWeekTooltipText = getDefaultString(_options.nextWeekTooltipText, "Nächste Woche");
    _options.addEventTooltipText = getDefaultString(_options.addEventTooltipText, "Füge ein Event dazu");
    ...
    _options.todayTooltipText = getDefaultString(_options.todayTooltipText, "Heute");
    _options.refreshTooltipText = getDefaultString(_options.refreshTooltipText, "Refresh");
    _options.searchTooltipText = getDefaultString(_options.searchTooltipText, "Suche");
    _options.expandDayTooltipText = getDefaultString(_options.expandDayTooltipText, "Expand Day");
    _options.listAllEventsTooltipText = getDefaultString(_options.listAllEventsTooltipText, "Zeige alle EVents");
    _options.listWeekEventsTooltipText = getDefaultString(_options.listWeekEventsTooltipText, "View Current Week Events");
    _options.fromText = getDefaultString(_options.fromText, "Von:");
    _options.toText = getDefaultString(_options.toText, "Bis:");
    _options.isAllDayText = getDefaultString(_options.isAllDayText, "Eintägig");
    _options.titleText = getDefaultString(_options.titleText, "Titel:");
    _options.descriptionText = getDefaultString(_options.descriptionText, "Beschreibung:");
    _options.locationText = getDefaultString(_options.locationText, "Ort:");
    _options.addText = getDefaultString(_options.addText, "Hinzufügen");
    _options.updateText = getDefaultString(_options.updateText, "Aktualisieren");
    _options.cancelText = getDefaultString(_options.cancelText, "Cancel");
    _options.removeEventText = getDefaultString(_options.removeEventText, "Entfernen");
    _options.addEventTitle = getDefaultString(_options.addEventTitle, "Event hinzufügen");
    _options.editEventTitle = getDefaultString(_options.editEventTitle, "Event bearbeiten");
    ...
    _options.stText = getDefaultString(_options.stText, "");
    _options.ndText = getDefaultString(_options.ndText, "");
    _options.rdText = getDefaultString(_options.rdText, "");
    _options.thText = getDefaultString(_options.thText, "");
    _options.yesText = getDefaultString(_options.yesText, "Yes");
    _options.noText = getDefaultString(_options.noText, "No");
    _options.allDayText = getDefaultString(_options.allDayText, "Eintägig");
    ...
    _options.confirmEventRemoveMessage = getDefaultString(_options.confirmEventRemoveMessage, "Das Entfernen dieses Events kann nicht rückgängig gemacht werden. Trotzdem fortfahren?");
    ...
    _options.selectColorsText = getDefaultString(_options.selectColorsText, "Farben bearbeiten");
    _options.backgroundColorText = getDefaultString(_options.backgroundColorText, "Hintergrundfarbe:");
    _options.textColorText = getDefaultString(_options.textColorText, "Text Farbe:");
    _options.borderColorText = getDefaultString(_options.borderColorText, "Rahmen Farbe:");
    ...
    _options.repeatsText = getDefaultString(_options.repeatsText, "Wiederholungen:");
    ...
    _options.typeText = getDefaultString(_options.typeText, "Option:");
  ...
  function setEventTypeTranslationStringOptions() {
    setEventTypeOption(_options.eventTypeHolidayText, "Urlaub", 0);
    setEventTypeOption(_options.eventTypeTaskText, "Installation", 1);
  }
